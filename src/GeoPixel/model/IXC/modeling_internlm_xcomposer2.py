...
class CustomCausalLMOutputWithPast(CausalLMOutputWithPast):
    ...
    """
    seg_token_mask: Optional[List] = None
...
class InternLMXComposer2ForCausalLM(InternLM2PreTrainedModel):
    ...
    def interleav_wrap(self, img_list, text_list, image_nums):
        ...
        final_input, final_atts, final_tars, final_mask, seg_token_mask = [], [], [], [], []
        ...
        for idx in range(len(temp_embeds)):
            ...
            seg_token_mask.append(final_tars[-1] == self.seg_token_idx)
        ...
        seg_token_mask = torch.cat(seg_token_mask, dim=0)
        return inputs_embeds, attention_mask, targets, im_mask, seg_token_mask
    ...
    def forward(self,
        ...
        if samples:
            ...
            if samples['data_type'][0] == 'text':
                has_img = False
            elif samples['data_type'][0] in {'multi', 'grounding'}:
                has_img = True
            else:
            ...
            if has_img:
                ...
                to_regress_embeds, attention_mask, targets, im_mask, seg_token_mask = self.interleav_wrap(
    ...
    def prepare_inputs_for_generation(self,
        ...
        if inputs_embeds is not None and past_key_values is None:
            if input_ids.shape[1]>1:
                ...
                im_mask = torch.cat([im_mask, zeros_to_append_im_mask], dim=1)
